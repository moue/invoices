    ...
    <div class="box box-primary">
        ...
        <div class="row"> 
            ...
            <div class="box-header">
                    <h3 class="box-title">Edit Your Settings</h3>                                    
                </div><!-- /.box-header -->                     
            <form style="padding: 0px 25px 20px;" class="form-horizontal" method="post" action="{{ URL::to('user/' . $user->id . '/edit') }}"  autocomplete="off">
                <!-- CSRF Token -->
